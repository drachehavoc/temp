...
(1,1,'imvI50/OcosY+JPUlnPXx8pPW/vxVx07HRgSYtZvHzkQyWI=',1,NULL,NULL);
...
CREATE TABLE `person` (
  ...
  `indication` varchar(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
insert  into `person`(`id`,`name`,`lastname`,`document_id`,`email`,`birth`,`birth_city`,`current_city`,`current_school`,`code`,`special`,`indication`) values 
(1,'Daniel','de Andrade Varela','0','0','1986-07-07 00:00:00',3060,4464,NULL,NULL,NULL,'1');
