...
MySQL - 10.3.13-MariaDB : Database - events
*********************************************************************
*/
...
(1,'any','Permissão para fazer qualquer coisa');
...
CREATE TABLE `activity` (
  ...
  CONSTRAINT `FK_atividade_evento_id` FOREIGN KEY (`event_id`) REFERENCES `event` (`id`),
  CONSTRAINT `FK_atividade_tipo_atividade_id` FOREIGN KEY (`activity_type_id`) REFERENCES `activity_type` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

/*Data for the table `activity` */

insert  into `activity`(`id`,`event_id`,`title`,`subtitle`,`description`,`seats`,`start_at`,`duration`,`activity_type_id`,`location`) values 
(1,1,'Instituto SENAI de inovação em Sistemas Embarcados\nPalestrante',NULL,'Alexandre Reeberg de Mello – SENAI/SC',-1,'2019-10-22 08:00:00',1.5,15,'Auditório Nobre'),
(2,1,'Visão computacional aplicada na indústria 4.0 e sistemas embarcados',NULL,'Flávio Gabriel Barbosa – SENAI/SC',-1,'2019-10-22 09:45:00',2.5,3,'Auditório Nobre'),
(3,1,'Criptomoedas: O Salto Quântico da Economia Moderna',NULL,'Raisa Melo',-1,'2019-10-24 08:00:00',1.5,15,'Auditório Nobre'),
(4,1,'Como Inovar Infinitamente',NULL,'Rodrigo Setti – Google/USA',-1,'2019-10-24 09:45:00',2.5,15,'Auditório Nobre'),
(5,1,'Como Inovar Infinitamente',NULL,'Rodrigo Setti – Google/USA',-1,'2019-10-24 19:30:00',2.5,15,'Auditório Nobre'),
(6,1,'MESMO HORÁRIO QUE O ULTIMO',NULL,'MESMO HORÁRIO QUE O ULTIMO',-1,'2019-10-24 19:30:00',0.5,13,'NOONONON');
...
(2,'asdasda','2019-09-22 12:13:14','2019-09-25 14:15:16');
...
/*Table structure for table `group_login` */

DROP TABLE IF EXISTS `group_login`;

CREATE TABLE `group_login` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `group_login_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`),
  CONSTRAINT `group_login_ibfk_2` FOREIGN KEY (`login_id`) REFERENCES `login` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `group_login` */

insert  into `group_login`(`id`,`group_id`,`login_id`) values 
(1,1,1);
...
CREATE TABLE `login` (
  ...
  CONSTRAINT `FK_usuario_grupo_id` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`),
  CONSTRAINT `FK_usuario_pessoa_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1;

/*Data for the table `login` */

insert  into `login`(`id`,`person_id`,`secret_key`,`group_id`,`recovery`,`recovery_time`) values 
(1,1,'imvI50/OcosY+JPUlnPXx8pPW/vxVx07HRgSYtZvHzkQyWI=',1,'1','2019-09-08 01:01:33'),
(14,19,'QRRlPyYDawus8fBhZyxxPkjysYnfmBDdiD+hyMvtFvZqyb8=',NULL,NULL,NULL),
(15,20,'9CowFCjgjZKL7PkVjNHdpWh6pAnXXBPO29587XE5lhbtN40=',NULL,NULL,NULL);
...
DROP TABLE IF EXISTS `permission_login`;
...
/*Data for the table `permission_login` */

insert  into `permission_login`(`id`,`login_id`,`permission_id`,`create_at`) values 
(1,1,1,'2019-09-01 17:05:22');
...
CREATE TABLE `person` (
  ...
  CONSTRAINT `pessonBirthCity` FOREIGN KEY (`birth_city`) REFERENCES `place_city` (`id`),
  CONSTRAINT `pessonCurrentCity` FOREIGN KEY (`current_city`) REFERENCES `place_city` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=latin1;

/*Data for the table `person` */

insert  into `person`(`id`,`name`,`lastname`,`document_id`,`email`,`birth`,`birth_city`,`current_city`,`current_school`,`code`,`special`) values 
(1,'Daniel','de Andrade Varela','0','daniel.varela@ifc.edu.br','1986-07-07 00:00:00',3060,4464,NULL,NULL,NULL),
(19,'daniel','de andrade varela','0','0','1986-07-07 00:00:00',3060,4464,'instituição de refêrenci','bsOfjMSJ',''),
(20,'daniel','de andrade varela','05362170929','daniel.c@asda.asd','1986-07-07 00:00:00',1,1,'aaaaaaaaa','L6ZJM2mC','bbbbbbbbb');
...
CREATE TABLE `place_city` (
  ...
  CONSTRAINT `place_city_ibfk_1` FOREIGN KEY (`state_id`) REFERENCES `place_state` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5565 DEFAULT CHARSET=latin1;

/*Data for the table `place_city` */

insert  into `place_city`(`id`,`name`,`state_id`) values 
(1,'Afonso Cláudio',8),
...
/*Data for the table `place_country` */

insert  into `place_country`(`id`,`name`,`iso`) values 
(1,'Brasil','BR');

/*Table structure for table `place_state` */

DROP TABLE IF EXISTS `place_state`;
...
CREATE TABLE `place_state` (
  ...
  PRIMARY KEY (`id`),
  KEY `country` (`country`),
  CONSTRAINT `FK_estado_pais2` FOREIGN KEY (`country`) REFERENCES `place_country` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=latin1;

/*Data for the table `place_state` */

insert  into `place_state`(`id`,`name`,`iso`,`country`) values 
(1,'Acre','AC',1),
(2,'Alagoas','AL',1),
(3,'Amazonas','AM',1),
(4,'Amapá','AP',1),
...
CREATE TABLE `subscription` (
  ...
  KEY `person_id` (`person_id`),
  CONSTRAINT `FK_inscricoes_atividade_id` FOREIGN KEY (`activity_id`) REFERENCES `activity` (`id`),
  CONSTRAINT `FK_inscricoes_pessoa_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=latin1;

/*Data for the table `subscription` */

insert  into `subscription`(`id`,`person_id`,`activity_id`,`subscribed_at`,`unsubscribed_at`,`check_in`,`check_out`) values 
(22,1,6,'2019-09-08 14:05:54',NULL,NULL,NULL),
(23,1,5,'2019-09-08 14:05:34','2019-09-08 14:05:53',NULL,NULL);
