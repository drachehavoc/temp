...
CREATE TABLE `permission_group` (
  ...
  PRIMARY KEY (`id`),
  KEY `grupo_id` (`gruop_id`),
  KEY `permission_id` (`permission_id`),
  CONSTRAINT `FK_permissao_grupo_grupo_id` FOREIGN KEY (`gruop_id`) REFERENCES `group` (`id`),
...
insert  into `permission_group`(`id`,`gruop_id`,`permission_id`) values 
(1,1,1);
